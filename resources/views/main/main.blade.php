...
<html lang="zxx">
    <head>
        ...
        <!-- linea-font css -->
        <link rel="stylesheet" type="text/css" href="{{ url('fonts/linea-fonts.css')}}">
        <!-- animate css -->
        ...
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="{{ url('main/main/css/magnific-popup.css')}}">
		<!-- rsmenu main css -->
        <link rel="stylesheet" type="text/css" href="{{ url('main/main/css/rsmenu-main.css')}}">
		<!-- rsmenu transitions css -->
        <link rel="stylesheet" type="text/css" href="{{ url('main/main/css/rsmenu-transitions.css')}}">
        <!-- style css -->
        <link rel="stylesheet" type="text/css" href="{{ url('main/style.css')}}"> <!-- This stylesheet dynamically changed from style.less -->
        <!-- responsive css -->
        <link rel="stylesheet" type="text/css" href="{{ url('main/main/css/responsive.css')}}">
        <!--[if lt IE 9]>
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li class="menu-item-has-children"><a href="#">Services</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="services-details.html">Servics Details</a></li>
                                            </ul>
                                        </li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="copyright">
                                <p>&copy; 2018 <a href="#">Your Company Name</a>. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
